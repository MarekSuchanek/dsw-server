...
question1Edited =
  ...
  , _valueQuestionNote = question1 ^. note
...
question1WithNewType =
  ...
  , _listQuestionNote = question1 ^. note
...
question2Edited =
  ...
  , _optionsQuestionNote = question2 ^. note
...
question2WithNewType =
  ...
  , _valueQuestionNote = question2 ^. note
...
question4Edited =
  ...
  , _listQuestionNote = question4 ^. note
...
question4WithNewType =
  ...
  , _optionsQuestionNote = question4 ^. note
...
q4_it1_question5Plain =
  ...
  , _listQuestionNote = q4_it1_question5 ^. note
